...
![Keychron Q1 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/Q1-Max-7.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q1_max/iso_encoder:keychron
    make keychron/q1_max/jis_encoder:keychron
    
Flashing example for this keyboard:

    make keychron/q1_max/ansi_encoder:keychron:flash
    make keychron/q1_max/iso_encoder:keychron:flash
    make keychron/q1_max/jis_encoder:keychron:flash
