...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [__MT] = LAYOUT_ansi_69(
        TD(TD_GRV_TILD),      KC_1,               KC_2,               KC_3,               KC_4,               KC_5,          KC_6,          KC_7,          KC_8,              KC_9,              KC_0,              KC_MINS,                         KC_EQL,   KC_BSPC,          KC_MUTE,
        KC_TAB,               KC_Q,               KC_W,               KC_E,               KC_R,               KC_T,          KC_Y,          KC_U,          KC_I,              KC_O,              KC_P,              KC_LBRC,                         KC_RBRC,  KC_BSLS,          KC_PSCR,
        MT(MOD_LCTL, KC_ESC), MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LCTL, KC_F), LT(_FN1,KC_G),                LT(_FN1,KC_H), MT(MOD_LCTL,KC_J), MT(MOD_LSFT,KC_K), MT(MOD_LALT,KC_L), MT(MOD_LGUI | MOD_RGUI,KC_SCLN), KC_QUOT,  KC_ENT,           KC_DEL,
