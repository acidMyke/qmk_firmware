...
![Keychron V1 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/V1-Max-1.jpg)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/v1_max/ansi_encoder:keychron
    make keychron/v1_max/iso_encoder:keychron
    make keychron/v1_max/jis_encoder:keychron
    
Flashing example for this keyboard:

    make keychron/v1_max/ansi_encoder:keychron:flash
    make keychron/v1_max/iso_encoder:keychron:flash
    make keychron/v1_max/jis_encoder:keychron:flash
