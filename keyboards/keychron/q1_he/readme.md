...
Make example for this keyboard (after setting up your build environment):
    ...
    make keychron/q1_he/iso_encoder:keychron
    make keychron/q1_he/jis_encoder:keychron

Flashing example for this keyboard:

    make keychron/q1_he/ansi_encoder:keychron:flash
    make keychron/q1_he/iso_encoder:keychron:flash
    make keychron/q1_he/jis_encoder:keychron:flash
